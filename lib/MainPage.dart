...
//=============== create to realtime databassse =================
    mainReference.child('devices').child(get_sn).set({
      ...
      'sn': get_sn,
      'room': get_room,
      "id": "$get_room,$get_sn,$getUuidStaff,$getStaffName",
      "uuid_staff" : getUuidStaff,
...
//=============== create to cloud firestore databassse =================
    Firestore.instance.runTransaction((Transaction transaction) async {
      ...
      Firestore.instance.collection('customer_booking');
      await reference.add({
        "email": widget.email,
        "uuid": uuid,
        "nik": nik,
...
final db = Firestore.instance;
  ...
  Widget build(BuildContext context) {
    ...
    TextEditingController(text: "Tex in Input Field");
    return Scaffold(
      appBar: AppBar(
...
//            ),
            ListTile(
              title: RaisedButton(
                ...
                color: Color.fromRGBO(255, 174, 0, 10),
                onPressed: () async {
                  final BluetoothDevice selectedDevice = await Navigator.of(context).push(
            ...
            Divider(),
            ListTile(
              title: const Text('Add Customer',textAlign: TextAlign.center,)
            ),
            ListTile(
                title : TextField(
                ...
                children: <Widget>[
                  ...
                  new FlatButton(
                      ...
                      child: Text(
                        _dateText,
                        style:
                        new TextStyle(fontSize: 18.0, color: Colors.black54,  fontStyle : FontStyle.italic),
                      )),
                ],
              ),
            ),
